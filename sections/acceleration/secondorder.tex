...
{\color{red}Since the frequency of particle-cloud collisions depends on their relative velocity, therefore the probability distribution for the incoming angle is:
\begin{equation}
