...
%\input{lectures/idealmhd}
%\input{lectures/mhdwaves}
%\input{lectures/qlt}
%\input{lectures/transportequation}
%\newpage
%
%\chapter{Particle Acceleration}
%\input{lectures/acceleration}
%\newpage
%
%\chapter{Particle Transport in Galactic environments}
%\input{lectures/protons}
%\input{lectures/implications}
%\newpage
%
%\chapter{The Physics of Galactic Sources}
%\input{lectures/sources}
%\newpage
%\newpage
%\chapter{Appendix}
%\input{lectures/app_larmor}
%\input{lectures/app_radtransfer}
%\input{lectures/app_thermodynamics}
%\input{lectures/app_rkconditions}
%\newpage
%
%% --- Bibliography ---
%
